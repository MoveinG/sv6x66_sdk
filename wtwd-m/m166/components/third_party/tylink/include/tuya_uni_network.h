...
INT_T tuya_unw_connect_raw(IN CONST INT_T fd, void *p_socket,IN CONST INT_T len);
...
INT_T tuya_unw_active(IN CONST INT_T fd,OUT UNW_IP_ADDR_T *addr,OUT USHORT_T *port);
