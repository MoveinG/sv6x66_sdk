...
ifeq ($(strip $(AYLA_CLOUD_EN)), 1)
IMPORT_DIR 		+=  components/third_party/ayla_sdk/ayla/src
IMPORT_DIR 		+=  components/third_party/ayla_sdk/platform/ssv6266
IMPORT_DIR 		+=  components/third_party/ayla_sdk/examples/ledevb
endif
...
#ifeq ($(strip $(AYLA_EN)), 1)
#INCLUDE += -I$(SDKDIR)/components/third_party/ayla_sdk/ayla/include
#INCLUDE += -I$(SDKDIR)/components/third_party/ayla_sdk/ayla/src/include
#INCLUDE += -I$(SDKDIR)/components/third_party/ayla_sdk/ayla/src/ext/jsmn
#INCLUDE += -I$(SDKDIR)/components/third_party/ayla_sdk/platform/ssv6266/include
#INCLUDE += -I$(SDKDIR)/components/third_party/ayla_sdk/platform/include
#INCLUDE += -I$(SDKDIR)/components/net/tcpip/$(LWIP_PATH)/src/include
# $(error $(INCLUDE))
#endif
...
ifeq ($(strip $(AYLA_CLOUD_EN)), 1)
CFLAGS += -DAL_HAVE_SIZE_T
CFLAGS += -DADA_BUILD_FINAL
CFLAGS += -DADA_BUILD_LOG_LOCK
CFLAGS += -DADA_BUILD_LOG_NO_BUF
CFLAGS += -DADA_BUILD_LOG_SERIAL
CFLAGS += -DADA_BUILD_LOG_THREAD_CT=8
CFLAGS += -DADA_BUILD_ANS_SUPPORT
CFLAGS += -DCONF_NO_ID_FILE
endif
