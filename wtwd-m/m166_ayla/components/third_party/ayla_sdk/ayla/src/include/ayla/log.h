...
/*
 * The persist name for the log module
 */
#define CONF_PNAME_LOG_MOD	"log_mod"
#define CONF_PNAME_LOG_CLIENT	"log_client"
...
void log_final(void);		/* Final logging - required with an OS */
#endif
